...
export const ExploreSectionRef = () => {
  const topics = [
    {
      icon: (
        <svg className="w-8 h-8 text-[#0A1E42]" fill="currentColor" viewBox="0 0 20 20">
    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-[#0A1E42] mb-6">
            What We&apos;ll Explore
          </h2>
