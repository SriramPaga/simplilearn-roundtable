import type { CardIcon } from './Card';
...
const sectionPadding =
  'max-w-[1440px] mx-auto px-[20px] lg:px-[104px] pt-[48px] lg:pt-[44px] pb-[64px] lg:pb-[72px]';

const headingText =
  'font-satoshi font-black text-[#F5AB40] text-[24px] leading-[32px] lg:text-[40px] lg:leading-[54px]';

const subheadingText =
  'font-satoshi font-medium text-black text-[15px] leading-[27px] lg:text-[25px] lg:leading-[34px]';
...
export const ExploreSection = () => {
  return (
    <section className="w-full bg-[rgba(210,225,255,0.5)]">
      <div className={sectionPadding}>
        {/* Heading */}
        <h2 className={`${headingText} mb-[12px]`}>
          What We’ll Explore
        </h2>

        {/* Subheading */}
        <p className={`${subheadingText} mb-[32px] lg:mb-[60px]`}>
