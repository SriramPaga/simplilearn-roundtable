...
const sectionPadding =
  'max-w-[1440px] mx-auto px-[20px] lg:px-[100px] pt-[44px] pb-[88px]';

const sectionHeading =
  'text-[#F5AB40] font-satoshi font-black text-[24px] leading-[32px] lg:text-[40px] lg:leading-[54px]';

const speakerName =
  'font-satoshi font-black text-[#00FFFF] text-[22px] leading-[30px] lg:text-[30px] lg:leading-[41px]';

const speakerBio =
  'font-satoshi font-medium text-white text-[15px] leading-[25px] lg:text-[24px] lg:leading-[35px]';
  ...
  return (
    <section className="bg-[linear-gradient(180deg,#1D4DF4_0%,#112D8E_100%)]">
      <div className={sectionPadding}>
        {/* Title */}
        <h2 className={`${sectionHeading} mb-[40px] lg:mb-[56px]`}>
          Featured Speakers
        </h2>
        ...
        <div className="space-y-[64px] lg:space-y-[72px]">
          {SPEAKERS.map((speaker) => (
            ...
            >
              ...
              {/* Text */}
              <div className="w-full max-w-[389px] lg:max-w-[821px] text-center lg:text-left">
                <h3 className={`${speakerName} mb-[8px] lg:mb-[12px]`}>
                  {speaker.name}
                </h3>
