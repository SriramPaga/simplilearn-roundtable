...
const bodyText =
  'font-satoshi font-medium text-black text-[15px] leading-[27px] lg:text-[27px] lg:leading-[39px]';

const containerPadding =
  'max-w-[1440px] mx-auto px-[20px] lg:px-[100px] pt-[64px] lg:pt-[96px] pb-[72px] lg:pb-[96px]';
  ...
  return (
    <section className="w-full bg-white">
      <div className={containerPadding}>
        ...
        {/* Intro Copy */}
        <div className="max-w-[389px] lg:max-w-[1240px] mb-[40px]">
        ...
        <h2
          className="
            font-satoshi font-black text-black text-center
            text-[25px] leading-[34px]
            lg:text-[40px] lg:leading-[54px]
            max-w-[347px] lg:max-w-[703px]
            mx-auto mb-[40px]
          "
        >
